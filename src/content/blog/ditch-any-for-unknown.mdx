...
So what's the big deal? The crucial difference is that `unknown` won't let you _do anything_ with the value until you first prove what it is. You are forced to handle the uncertainty before you can use it.
