...
2. **It Works _With_ Your Linter:** Instead of disabling the incredibly useful `@typescript-eslint/no-unused-vars` rule, you configure it to respect this convention. You get the best of both worlds: you still catch _truly_ unused variables (like typos or leftovers from a refactor) while allowing the intentionally unused ones to pass.
